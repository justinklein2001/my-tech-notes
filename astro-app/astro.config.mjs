					...
					items: [
						{
							...
							collapsed: true,
							items: [
								{ label: 'Overview', slug: 'tailwind/overview' },
								{ label: '1. Introduction', slug: 'tailwind/introduction' },
								{ label: '2. Layouts & Flex-box', slug: 'tailwind/layout' },
								{ label: '3. Custom Styling & Reusability', slug: 'tailwind/customstyling' },
								{ label: '4. Media Queries & Responsive Design', slug: 'tailwind/responsive' },
							],
						}
					],
				},

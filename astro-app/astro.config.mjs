			...
			sidebar: [
				{
					...
					items: [
						...
						// { label: '15. Virtual Network Services', slug: 'aws/cloudcomputing' },
						// { label: '16. Designing Cost-Optimized Compute', slug: 'aws/cloudcomputing' },
						// { label: '17. Designing for Operational Excellence', slug: 'aws/cloudcomputing' },
